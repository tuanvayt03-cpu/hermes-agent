...
REQUIRED_STATES = ("DONE", "READY", "RUNNING", "BLOCKED", "FUTURE", "INVALIDATED")
REQUIRED_OUTPUTS = ("READY_FRONTIER", "CRITICAL_PATH", "PARALLEL_SAFE_FRONTIER")
VALID_STATES = frozenset(REQUIRED_STATES)
